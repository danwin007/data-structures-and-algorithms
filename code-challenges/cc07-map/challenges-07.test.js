...
const extractAbilities = (arr) => {
  // Solution code here...
  let arrAb = snorlaxAbilities.abilities.map(index => {
...
const extractStats = (arr) => {
  // Solution code here...
  let arrStat = snorlaxStats.stats.map( index => {
    return {
      name: index.stat.name,
      total: index.effort + index.baseStat
    }
  }); return arrStat;
};
